...
//        System.out.println(request.getParameter("username"));
        ...
        logMapper.CommonException(request.getRequestURI(),request.getRemoteUser(),request.getRemoteAddr(),excp,param,"CommonFail",time,"front");
    }
...
//        System.out.println(request.getParameter("username"));
        ...
        SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        String time = formatter.format(date);
        logMapper.loginFailException(request.getRequestURI(),request.getRemoteUser(),request.getRemoteAddr(),excp,param,"loginFail",time,"front");
