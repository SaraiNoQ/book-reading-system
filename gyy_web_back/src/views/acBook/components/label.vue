    ...
    <div ref="label">
        ...
        >
            <div class="label-container">
                <div ref="annotator" class="label-anno"></div>
            </div>
...
export default {
    ...
    methods: {
        ...
        beforeSave () {
          this.$confirm('确认保存？')
            .then(async _ => {
              // TODO: 保存
              console.log('save-label', this.example1.store.json);
    ...
    computed: {
        ...
        chapterIdCom: {
          get () {
            return this.chapterId = this.chooseId
          }
        }
    },
    watch: {
      visible (val) {
        if (val) {
          ...
          this.$nextTick(()=> {
            console.log('refs', this.labelFromDataData)
            ...
            console.log('example', this.example1)
          })
        }
      },
      labelFromCom (val) {
      ...
      chapterIdCom (val) {
        console.log('watch chapterIdCom', val)
      },
