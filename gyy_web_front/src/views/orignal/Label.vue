<template>
  <div class="example">
    <div class="anno" ref="annotator"></div>
  </div>
</template>
...
export default {
  ...
  mounted () {
    ...
    const example1 = new Annotator(json, this.$refs.annotator)
    example1.on('textSelected', (startIndex, endIndex) => {
      console.log('selected', data.content.slice(startIndex, endIndex))
    })
    example1.on('labelClicked', (id) => {
